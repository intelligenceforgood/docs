...
| project_root | `project_root` | `I4G_PROJECT_ROOT` | `Path` | `/Users/jerry/Work/project/i4g/core` | Top-level configuration model with nested sections for each subsystem. |
