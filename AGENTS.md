...
> **For the Antigravity Agent:** Auto-read this file when working in the `docs/` repo. For GitBook formatting reference, read `docs/skill.md` in this repo root.
...
- Developer onboarding, workflow guides, coding standards
- Debugging guides, deployment procedures, config manifests

Developer documentation belongs in:

- `antigravity/docs/` — Skill framework guides and developer onboarding
...
The canonical GitBook formatting reference is `docs/skill.md` (this repo root). Read it for custom blocks, frontmatter, variables, and configuration syntax.
...
- For I4G documentation rules, read `antigravity/knowledge/standards/docs.md`
