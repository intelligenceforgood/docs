...
For deeper implementation details, cross-reference the infrastructure modules in [`infra/environments`](../../infra/environments) and the migration scripts in [`proto/scripts/migration`](../../proto/scripts/migration).
