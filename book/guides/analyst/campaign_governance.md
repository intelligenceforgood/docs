...
- **Goal:** Detect and stop a specific wave of attacks happening _now_.
...
surfaced on the **Intelligence → Campaigns** page alongside manually governed
campaigns.

Key differences between governance campaigns and threat campaigns:

| Aspect       | Governance Campaign   | Threat Campaign                |
| ------------ | --------------------- | ------------------------------ |
| Creation     | Manual (analyst)      | Auto-detected by aggregation   |
| Lifecycle    | Stable, policy-driven | Dynamic, risk-driven           |
| Management   | CRUD in campaign list | Rename, merge, split, link     |
| Risk scoring | N/A                   | 0–100 composite score          |
| LEA referral | Manual                | Auto-suggested above threshold |

See [Threat Campaigns](campaigns.md) for the full campaign intelligence user
guide.
